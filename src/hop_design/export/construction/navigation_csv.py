        ...
        writer.writerow(
            {
                **base,
                ...
                "foldback_relaxation_radius": route.foldback_relaxation_radius,
                "basal_relaxation_radius": _optional(route.basal_relaxation_radius),
                "exact_geometry": route.exact_geometry,

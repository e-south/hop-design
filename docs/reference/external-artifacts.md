...
Selected construction bundles still undergo staged semantic verification before
publication. Their nested files and single-file references use owner-only access.
